...
class SpecLoader:
    """Resolves a configured ``"<module-or-path>:<Class>"`` string to the class it names."""

    def load_class(self, spec: str, base: type[_T]) -> type[_T]:
        ...
        module = self._import(module_ref, spec)
    ...
    def _import(self, module_ref: str, spec: str) -> ModuleType:
